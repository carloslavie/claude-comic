...
Los tests cubren solo la lógica pura (`orientation.js`, `layout.js`, `colors.js`, `titleStyle.js` y `pdfFormat.js`). La UI, el render en canvas y el PDF se verifican a mano (ver los criterios de aceptación de `specs/01-mvp-comic-pdf.md`).
